...
class Crack():
    ...
    def open(self):
        ...
        keyword.send_keys('')
        # bowton.click()
        # login_element = self.browser.find_element_by_xpath('//*[@class="header"]/div')
        # login_element.click()
        # self.browser.implicitly_wait(10)
        # iframe = self.browser.find_element_by_id('dialogIframe')
        # self.browser.switch_to.frame(iframe)
        # login_method = self.browser.find_element_by_xpath('//*[@class="login-form"]/div[2]')
        # login_method.click()
        # username = self.browser.find_element_by_id("loginname")
        # password = self.browser.find_element_by_id("nloginpwd")
        # login_button = self.browser.find_element_by_xpath('//*[@class="login-btn"]')
        # while True:
        #     try:
        #         username.clear()
        #         password.clear()
        #         username.send_keys('23412')
        #         password.send_keys('12341234')
        #         login_button.click()
        #         captcha = self.browser.find_element_by_xpath('//*[@class="JDJRV-slide"]')
        #         background = self.browser.find_element_by_xpath('')
        #         slide = self.browser.find_element_by_xpath()
        #
        #     except:
        #         pass
