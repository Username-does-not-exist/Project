...
class Crawl(object):
    ...
    def construct(self):
        ...
        for i in range(2, 250):
            url = "http://www.fengj.com/so/SearchInfo.aspx?keyword=%b7%cf%d6%bd&info_type=gongqiu&page={}".format(i)
            url_list.append(url)
            header = {
    ...
    def construct_headers(self):
        ...
        for i in range(1, 249):
            header = {
                "Referer": "http://www.fengj.com/so/SearchInfo.aspx?keyword=%b7%cf%d6%bd&info_type=gongqiu&page={}".format(i),
                "Upgrade-Insecure-Requests": "1",
                "User-Agent": UAPool().get()
                }
